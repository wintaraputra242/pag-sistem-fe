<template>
  <div class="dashboard-editor-container">
    <h1 style="text-align: center; font-family: Poppins; font-weight: 600;">SUPPLIER</h1>
    <div class="app-container">
      <div class="filter-container" style="margin-bottom: 8px;">
        <form @submit.prevent="handleFilter">
          <el-input
            v-model="filter.nama_kategori"
      ...
      >
        ...
        <el-table-column label="No. Telpon">
          <template slot-scope="{}">
            <span>084123123122</span>
          </template>
        </el-table-column>
        <el-table-column label="No. Fax">
          <template slot-scope="{}">
            <span>0361123123</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Nama Kontak">
          <template slot-scope="{$index}">
            <span>Kontak {{ $index + 1 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="No. Telp. Kontak">
          <template slot-scope="{}">
            <span>084123123122</span>
          </template>
        </el-table-column>
        <el-table-column label="Email Kontak">
          <template slot-scope="{}">
            <span>email@gmail.com</span>
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="roleUser === '1'" label="Aksi" class-name="small-padding fixed-width" fixed="right">
          <template slot-scope="{row}">
            <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
              <el-tooltip class="item" effect="dark" content="Diskon Item" placement="bottom">
                <el-button class="btn-table" type="info" icon="el-icon-s-goods" size="small" @click="dialogDiskonVisible = true" />
              </el-tooltip>
        ...
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
          <el-row :gutter="20">
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Supplier" prop="supplier">
            ...
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="No. Telpon" prop="no_telp">
                <el-input v-model="temp.no_telp" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="No. Fax" prop="no_fax">
                <el-input v-model="temp.no_fax" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Nama Kontak" prop="nama_kontak">
                <el-input v-model="temp.nama_kontak" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="No. Telp. Kontak" prop="no_telp_kontak">
                <el-input v-model="temp.no_telp_kontak" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Email Kontak" prop="email_kontak">
                <el-input v-model="temp.email_kontak" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
      ...
      <el-dialog :title="isTambahDiskon ? 'Tambah Diskon' : 'Diskon'" :width="isWidthMobile ? '95%' : '75rem'" :visible.sync="dialogDiskonVisible" :top="isWidthMobile ? '0' : '10px'" style="padding: 20px 0;">
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
          <div>
            <p style="margin: 0; padding: 0;">Suplier : <b>Suplier A</b></p>
          </div>
          <div>
            <el-button v-if="!isTambahDiskon" type="success" icon="el-icon-plus" @click="isTambahDiskon = true">
              Tambah Diskon
            </el-button>
            <el-button v-else type="info" icon="el-icon-arrow-left" @click="isTambahDiskon = false">
              Daftar Diskon
            </el-button>
          </div>
        </div>
        ...
        >
          ...
          <el-table-column label="Status">
            <template slot-scope="{$index}">
              <span>{{ discountSelected === $index ? 'Aktif' : 'Tidak Aktif' }}</span>
            </template>
          </el-table-column>
          <el-table-column v-if="roleUser === '1'" label="Aksi" class-name="small-padding fixed-width" width="110" fixed="right">
            <template slot-scope="{$index}">
              <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
                <el-button class="btn-table" type="primary" size="small" :disabled="discountSelected === $index" @click="discountSelected = $index">Gunakan</el-button>
                <!-- <el-tooltip class="item" effect="dark" content="Hapus Data" placement="bottom">
                  <el-button class="btn-table" size="small" icon="el-icon-delete" type="danger" @click="handleDelete(row.id_user, row.nama)" />
                </el-tooltip> -->
              </div>
        ...
        <div v-else style="margin-top: 10px;">
          <el-form ref="formDataItem" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
            <el-row :gutter="10">
              <el-col :md="12" :span="24">
                <el-form-item class="form-item" label="Diskon" prop="diskon">
                  <el-input v-model="tempRak.diskon" />
                </el-form-item>
              </el-col>
              <el-col :md="12" :span="24">
                <el-form-item class="form-item" label="Status" prop="status">
                  <el-input v-model="tempRak.status" />
                </el-form-item>
              </el-col>
            </el-row>
            <div class="dialog-footer" style="float: right; margin-top: 10px;">
              <el-button type="info" icon="el-icon-close" @click="isTambahDiskon = false">
                Batal
              </el-button>
              <el-button type="success" icon="el-icon-check" :loading="loadingBtn" native-type="submit">
                Simpan
