<template>
  <div class="dashboard-editor-container">
    <h1 style="text-align: center; font-family: Poppins; font-weight: 600;">EXAMPLE PAGE</h1>
    <div class="app-container">
      <div class="filter-container" style="margin-bottom: 8px;">
        ...
        <el-button v-waves class="filter-item" style="margin: -2px 5px 0 0" type="primary" icon="el-icon-search">
          Cari
        </el-button>
        <el-button class="filter-item" style=" margin: -2px 5px 0 0" type="info" icon="el-icon-refresh" :disabled="totalUserPusat === totalUserPusatOld">
          Reset
        </el-button>
        <el-button v-if="roleUser === '1'" class="filter-item" style=" margin: -2px 5px 0 0" type="success" icon="el-icon-upload2">
          Upload Data
        </el-button>
        <!-- </form> -->
          ...
          <el-row :gutter="20">
            ...
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Password" prop="password">
                <template>
                  <el-input v-model="temp.password" show-password :disabled="dialogStatus === 'update'" />
                </template>
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
            ...
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="No. HP" prop="hp">
                <template>
                  <el-input v-model="temp.hp" @input="formatPhone" />
                </template>
              </el-form-item>
            </el-col>
            <el-col :span="24">
            ...
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Level" prop="level">
                <template>
                  <el-select v-model="temp.level" style="width: 100%" clearable>
                    <el-option
