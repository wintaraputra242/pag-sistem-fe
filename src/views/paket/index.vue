<template>
  <div class="dashboard-editor-container">
    <h1 style="text-align: center; font-family: Poppins; font-weight: 600;">PAKET</h1>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="Nama Paket">
      ...
      <el-dialog :title="textMap[dialogStatus]" :width="isWidthMobile ? '95%' : ''" :visible.sync="dialogFormVisible" :top="isWidthMobile ? '0' : '60px'" style="padding: 20px 0;">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item class="form-item" label="Nama Paket" prop="nama_paket">
      ...
      <el-dialog :title="isTambahItem ? 'Tambah Item' : 'Item'" :width="isWidthMobile ? '95%' : '75rem'" :visible.sync="dialogPaketVisible" :top="isWidthMobile ? '0' : '10px'" style="padding: 20px 0;">
