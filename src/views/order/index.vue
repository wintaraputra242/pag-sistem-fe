<template>
  <div class="dashboard-editor-container">
    <h1 style="text-align: center; font-family: Poppins; font-weight: 600;">ORDER PEMBELIAN</h1>
    <div class="app-container">
      <div class="filter-container" style="margin-bottom: 8px;">
        <form @submit.prevent="handleFilter">
          <el-input
            v-model="filter.no_po"
      ...
      >
        ...
        <el-table-column label="No. PO.">
          <template slot-scope="{$index}">
            <span>523412231 {{ $index + 1 }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Gudang">
          <template slot-scope="{$index}">
            <span>Gudang {{ $index + 1 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="Total Jml.">
          <template slot-scope="{}">
            <span>3</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="Tgl. Pakai">
          <template slot-scope="{}">
        ...
        <el-table-column v-if="roleUser === '1'" label="Aksi" class-name="small-padding fixed-width" width="110" fixed="right">
          <template slot-scope="{row}">
            <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
              <el-tooltip class="item" effect="dark" content="Order Item" placement="bottom">
                <el-button class="btn-table" type="info" icon="el-icon-coin" size="small" @click="dialogItemVisible = true" />
              </el-tooltip>
      ...
      <el-dialog :title="textMap[dialogStatus]" :width="isWidthMobile ? '95%' : '80%'" :visible.sync="dialogFormVisible" :top="isWidthMobile ? '0' : '10px'" style="padding: 20px 0;">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
          <el-row :gutter="20">
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="No. PO" prop="nama_kategori">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="Tanggal" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="Tanggal Dipakai" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="Supplier" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="Gudang" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="8" :span="24">
              <el-form-item class="form-item" label="Rak" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <div style="border: 1px solid gray; border-radius: 10px; padding: 10px; margin-bottom: 10px;">
                <el-row :gutter="20">
                  <el-col :span="24">
                    <div style="display: flex; align-items: center; gap: 10px; width: 100% !important;">
                      <div style="width: 100%;">
                        <el-form-item class="form-item" label="Item" prop="nama_kategori">
                          <el-input v-model="temp.nama_kategori" />
                        </el-form-item>
                      </div>
                      <el-button type="success" icon="el-icon-plus" :loading="loadingBtn" native-type="submit" style="margin-top: 13px;">
                        Tambah
                      </el-button>
                    </div>
                  </el-col>
            ...
            <el-col :span="24">
              <el-form-item class="form-item" label="Subtotal" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="6" :span="24">
              <el-form-item class="form-item" label="Disk. Faktur (%)" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="6" :span="24">
              <el-form-item class="form-item" label="Disk. Faktur (Rp)" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="6" :span="24">
              <el-form-item class="form-item" label="Pajak (%)" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="6" :span="24">
              <el-form-item class="form-item" label="Pajak (Rp)" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Biaya Lain-lain" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <v-divider />
              <el-form-item class="form-item" label="Grand Total" prop="keterangan">
                <el-input v-model="temp.nama_kategori" />
              </el-form-item>
            </el-col>
          </el-row>
