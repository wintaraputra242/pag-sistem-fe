<template>
  <div class="dashboard-editor-container">
    <h1 style="text-align: center; font-family: Poppins; font-weight: 600;">GUDANG</h1>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="Nama Gudang">
        ...
        <el-table-column label="Alamat">
          <template slot-scope="{}">
            <span>Jl. Raya Alamat</span>
          </template>
        </el-table-column>
        <el-table-column label="No. Telepon">
          <template slot-scope="{}">
            <span>081123123123</span>
          </template>
        </el-table-column>
        <el-table-column label="No. Fax">
          <template slot-scope="{}">
            <span>036112312312</span>
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="roleUser === '1'" label="Aksi" class-name="small-padding fixed-width" min-width="110" fixed="right">
          <template slot-scope="{row}">
            <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
              <el-tooltip class="item" effect="dark" content="Rak Data" placement="bottom">
                <el-button class="btn-table" type="info" icon="el-icon-s-grid" size="small" @click="dialogRakVisible = true" />
              </el-tooltip>
      ...
      <el-dialog :title="textMap[dialogStatus]" :width="isWidthMobile ? '95%' : ''" :visible.sync="dialogFormVisible" :top="isWidthMobile ? '0' : '60px'" style="padding: 20px 0;">
        <el-form ref="dataForm" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item class="form-item" label="Nama Gudang" prop="nama_gudang">
                <el-input v-model="temp.nama" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="Alamat" prop="alamat">
                <el-input v-model="temp.nama" type="textarea" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
            ...
            <el-col :md="12" :span="24">
              <el-form-item class="form-item" label="No. Telepon" prop="no_telepon">
                <el-input v-model="temp.nama" />
              </el-form-item>
            </el-col>
            <el-col :md="12" :span="24">
      ...
      <el-dialog :title="isTambahRak ? 'Tambah Rak' : 'Rak'" :width="isWidthMobile ? '95%' : '75rem'" :visible.sync="dialogRakVisible" :top="isWidthMobile ? '0' : '10px'" style="padding: 20px 0;">
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
          <div>
            <p style="margin: 0; padding: 0;">Gudang : <b>Bengkel A</b></p>
          </div>
          <div>
            <el-button v-if="!isTambahRak" type="success" icon="el-icon-plus" @click="isTambahRak = true">
              Tambah Rak
            </el-button>
            <el-button v-else type="info" icon="el-icon-arrow-left" @click="isTambahRak = false">
              Daftar Rak
            </el-button>
          </div>
        </div>
        ...
        >
          ...
          <el-table-column label="Nama Rak" min-width="120">
            <template slot-scope="{$index}">
              <span>Rak {{ $index + 1 }}</span>
            </template>
          </el-table-column>
          <el-table-column label="Keterangan" min-width="120">
            <template slot-scope="{$index}">
              <span>Keterangan {{ $index + 1 }}</span>
            </template>
          </el-table-column>
          <el-table-column v-if="roleUser === '1'" label="Aksi" class-name="small-padding fixed-width" width="110" fixed="right">
            <template slot-scope="{row}">
              <div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 5px;">
                ...
                <el-tooltip class="item" effect="dark" content="Edit Data" placement="bottom">
                  <el-button class="btn-table" type="primary" icon="el-icon-edit" size="small" @click="isTambahRak = true" />
                </el-tooltip>
                <el-tooltip class="item" effect="dark" content="Hapus Data" placement="bottom">
                  <el-button class="btn-table" size="small" icon="el-icon-delete" type="danger" @click="handleDelete(row.id_user, row.nama)" />
                </el-tooltip>
        ...
        <div v-else style="margin-top: 10px;">
          <el-form ref="formDataItem" :rules="rules" :model="temp" label-position="top" style="width: 100%;" @submit.native.prevent="dialogStatus==='create'?createData():updateData()">
            <el-row :gutter="10">
              <el-col :span="24">
                <el-form-item class="form-item" label="Nama Rak" prop="nama_rak">
                  <el-input v-model="tempRak.nama_rak" />
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item class="form-item" label="Keterangan" prop="nama_rak">
                  <el-input v-model="temp.nama" type="textarea" />
                </el-form-item>
              </el-col>
            </el-row>
            <div class="dialog-footer" style="float: right; margin-top: 10px;">
              <el-button type="info" icon="el-icon-close" @click="isTambahRak = false">
                Batal
              </el-button>
              <el-button type="success" icon="el-icon-check" :loading="loadingBtn" native-type="submit">
                Simpan
